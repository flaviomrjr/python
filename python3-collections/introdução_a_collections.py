...
class Conta(metaclass=ABCMeta):
  ...
  #DEFINIR UM METODO ABSTRATO QUANDO VOCÊ QUER QUE ESSE METODO ESTEJA INSTANCIADOS EM TODAS AS CLASSES
  @abstractmethod
...
class ContaSalario:
  ...
  def __init__(self, codigo):
    self._codigo = codigo
    self._saldo = 0
  #ADICIONANDO COMPARAÇAO DE IGUALDADE NA CLASSE
  def __eq__(self, outro):
    #DEFININDO QUE O TIPO DEVE SER CONTASALARIO
...
class ContaSalario:
  ...
  #VERIFICANDO SE UM OBJETO E MENOR QUE O OUTRO
